...
0.23 2009-08-29 Changed the header for support doccumentation
'''

"""
:mod:`pypso` -- the main pypso namespace
================================================================

This is the main module of the pypso, every other module
is above this namespace, for example, to import :mod:`Topology`:
